...
{	
	...
	class IMission
	{
		...
		public:
			...
			virtual void    AddGameObject      (EObjType ObjType, EObjType CreatorType, const CFPoint& Where, float Countdown, EObjectCreationFlags Flags, const FMetadata* Options = nullptr);
